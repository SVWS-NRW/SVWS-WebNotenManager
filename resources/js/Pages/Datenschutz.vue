        ...
        <AuthLayout>
            <template #main>
                <div class="mx-auto w-full max-w-6xl bg-white rounded shadow-lg p-12 flex flex-col gap-6 grow">
                    <h2 class="headline-2">DATENSCHUTZBESTIMMUNGEN</h2>
                    <h3 class="headline-3">Verantwortlicher und Datenschutzbeauftragter</h3>
                    ...
                    <h4 class="headline-4">Log-Dateien</h4>
                    ...
                    <h4 class="headline-4">Personenbezogene Daten</h4>
                    ...
                    <h4 class="headline-4">Datenübertragung</h4>
                    ...
                    <h4 class="headline-4">Copyright</h4>
