        ...
        <AuthLayout>
            <template #main>
                <div class="mx-auto w-full max-w-6xl bg-white rounded shadow-lg p-12 flex flex-col gap-6 grow">
                    <h2 class="headline-2">Erklärung zur Barrierefreiheit</h2>

                    <h3 class="headline-3">Barrierefreiheit dieser Internetseite</h3>
                    ...
                    <h3 class="headline-3">Stand der Vereinbarkeit mit den Anforderungen zur barrierefreien Informationstechnik</h3>
                    ...
                    <h3 class="headline-3">Erstellung dieser Erklärung</h3>
                    <p>Diese Erklärung wurde am 30. November 2020 zu Düsseldorf erstellt.</p>

                    <h3 class="headline-3">Feedback und Kontakt</h3>
                    ...
                    <h3 class="headline-3">Überwachungsstelle für barrierefreie Informationstechnik des Landes Nordrhein-Westfalen</h3>
                    <p>Die Überwachungsstelle für barrierefreie Informationstechnik des Landes Nordrhein-Westfalen prüft regelmäßig, ob und inwiefern Internetseiten und mobile Anwendungen öffentlicher Stellen des Landes den Anforderungen an die Barrierefreiheit genügen.
                        Ziel der Arbeit der Überwachungsstelle ist es, die Einhaltung der Anforderungen an die barrierefreie Informationstechnik sicherzustellen und für eine flächendeckende Umsetzung der gesetzlichen Regelungen zu sorgen.
                        Eine E-Mail an die Überwachungsstelle können Sie an die E-Mail-Adresse <a href="mailto:ombudsstelle-barrierefreie-it@mags.nrw.de" target="_blank">ombudsstelle-barrierefreie-it@mags.nrw.de</a> senden.
                        Weitere Informationen zur Überwachungsstelle finden Sie hier: <a href="https://www.mags.nrw/ueberwachungsstelle-barrierefreie-informationstechnik" target="_blank">www.mags.nrw/ueberwachungsstelle-barrierefreie-informationstechnik</a>
                    </p>
                    <h3 class="headline-3">Schlichtungsverfahren/Durchsetzungsverfahren</h3>
                    <p>Sollten Sie auf Mitteilungen oder Anfragen zur barrierefreien Informationstechnik dieser Internetseite keine zufriedenstellende Antwort erhalten, können Sie die Ombudsstelle für barrierefreie Informationstechnik des Landes Nordrhein-Westfalen einschalten. Die Ombudsstelle ist der Beauftragten für die Belange der Menschen mit Behinderung zugeordnet und in §§ 10d, 10e BGG NRW und §§ 9 ff der BITV NRW gesetzlich verankert. Unter Einbeziehung aller Beteiligten versucht die Ombudsstelle, die Umstände der fehlenden Barrierefreiheit zu ermitteln, damit der Träger diese beheben kann. Dabei geht es nicht darum, Gewinner oder Verlierer zu finden. Vielmehr ist es das Ziel, mit Hilfe der Schlichtungsstelle gemeinsam und außergerichtlich eine Lösung für ein Problem zu finden.
                        ...
                        Weitere Informationen zur Ombudsstelle für barrierefreie Informationstechnik NRW finden Sie hier: <a href="https://www.mags.nrw/ombudsstelle-barrierefreie-informationstechnik" target="_blank">www.mags.nrw/ombudsstelle-barrierefreie-informationstechnik</a></p>
                </div>
            </template>
        </AuthLayout>
    </div>
...
<style scoped>
    ...
    main ol {
        @apply list-decimal list-outside ml-4 flex flex-col gap-3
    }
