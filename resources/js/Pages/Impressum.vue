<script setup lang="ts">
    ...
    import { SvwsUiContentCard } from '@svws-nrw/svws-ui'
        ...
        <AuthLayout>
            <template #main>
                <div class="component">
                    ...
                    <p>{{ settings.school_name }} <br> {{ settings.school_address }}</p>

                    <h2 class="headline-2">Schulleitung</h2>
                    <p>{{ settings.school_management_name }} <br> Telefon-Nr.: {{ settings.school_management_telephone }} <br> E-Mail: {{ settings.school_management_email }}</p>
                    ...
                    <h2 class="headline-2">Schulträger</h2>
                    <h3 class="headline-3">Diensteanbieter im Sinne des TMG</h3>
                    <p>{{ settings.school_board_name }} <br> {{ settings.school_board_address }} <br> {{ settings.school_board_contact }}</p>

                    <h2 class="headline-2">Urheberrecht</h2>
