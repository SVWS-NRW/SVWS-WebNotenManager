                ...
                <div id="login">
                    <header>
                        ...
                        <div class="form">
                            ...
                            <SvwsUiButton @click="submit()" title="Anmelden" :disabled="form.processing">Anmelden</SvwsUiButton>
                        </div>
                    </header>

                    <footer>
                        <img src="@/Images/MSB_NRW_Logo.svg" alt="Ministerium für Schule und Bildung des Landes Nordrhein-Westfallen" />
                        <p>
...
<style scoped>
    ...
    #login > header > h1 {
        @apply mb-12 flex flex-row items-center space-x-4 text-3xl font-bold w-full
    }
