...
=======
                <div class="flex h-full w-screen flex-col justify-between px-16 max-w-[581px]">
                    <header class="space-y-16 pt-16">
                        <div class="mb-12 flex flex-row items-center gap-4 w-full">
                            <svg viewBox="0 0 1000 1000" aria-hidden="true" class="h-12 w-12">
>>>>>>> develop
                                ...
                                <path fill="#020202" d="M0 500V0h1000v1000H0V500zm983.5 0V16.5h-967L16.2 499c-.1 265.4 0 483 .3 483.8.3 1 97.6 1.2 483.7 1l483.3-.3V500z" />
                            </svg>
<<<<<<< HEAD
                            <div class="headline">
                                <h1>SVWS-NRW</h1>
                                <span>WeNoM - WebNotenManager</span>
                            </div>
                        </div>
...
=======
                            <div class="flex flex-col">
                                <h1 class="text-3xl font-bold">SVWS-NRW</h1>
                                <span class="font-medium">WeNoM - WebNotenManager</span>
                            </div>
                        </div>
...
>>>>>>> develop
                    ...
                    <footer class="flex-shrink-0 space-y-4 pb-8 pt-16">
                        <img src="@/Images/MSB_NRW_Logo.svg" class="h-auto w-80" alt="Ministerium für Schule und Bildung des Landes Nordrhein-Westfallen" />
                        <p class="text-sm">
                            ...
                            Erzieher usw. zurückgegriffen. An Stellen, wo das nicht möglich ist, wird versucht alle Geschlechter gleichermaßen zu verwenden.
                        </p>
<<<<<<< HEAD
                        <nav>
...
>>>>>>> develop
            ...
            <template #main>
                <div class="bg-login-background bg-cover bg-center block min-h-screen w-full"></div>
            </template>
        </SvwsUiAppLayout>
    </div>
</template>
...
<style scoped>
    ...
    #login > footer  {
        @apply flex-shrink-0 space-y-4 pb-8 pt-16
    }
    ...
    #login > footer > nav > a {
        @apply inline-block text-sm underline
    }

    #background  {
        @apply bg-login-background bg-cover bg-center block min-h-screen w-full
    }
</style>
=======
>>>>>>> develop
