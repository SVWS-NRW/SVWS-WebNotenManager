...
<script setup lang="ts">
    ...
    import { DataTableColumn, SvwsUiButton, SvwsUiMultiSelect, SvwsUiTable, SvwsUiTextareaInput, SvwsUiTextInput, SvwsUiContentCard } from '@svws-nrw/svws-ui';
    import { addSelectedToBemerkung, closeEditor, formatBasedOnGender, pasteShortcut, search, multiselect } from '@/Helpers/bemerkungen.helper';
...
<style scoped>
    ...
    .buttons {
        @apply ui-flex ui-justify-end ui-gap-3 ui-mt-3
    }
</style>
