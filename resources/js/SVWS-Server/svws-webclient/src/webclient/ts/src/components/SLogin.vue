...
<style>
.login-wrapper {
	@apply flex h-full w-screen flex-col justify-between px-16;
	max-width: 581px;
}
...
.login-form-header {
	@apply mb-12 flex flex-row items-center space-x-4 text-3xl font-bold;
}
