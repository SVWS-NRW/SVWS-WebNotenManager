...
<style>
	...
	.svws-ui--sidebar--menu--body .svws-ui--sidebar--menu-item,
	.svws-ui--sidebar--menu--footer .svws-ui--sidebar--menu-item {
		@apply svws-ui-text-white;
	}

	.svws-ui--sidebar--menu--body .svws-ui--sidebar--menu-item--active,
	.svws-ui--sidebar--menu--footer .svws-ui--sidebar--menu-item--active {
		@apply svws-ui-border-white;
		@apply svws-ui-font-bold;
	}

	.svws-ui--secondary-menu--content .svws-ui--sidebar--menu-item {
		@apply svws-ui-text-dark;
	}

	.svws-ui--secondary-menu--content .svws-ui--sidebar--menu-item--active {
		@apply svws-ui-border-dark;
		@apply svws-ui-font-bold;
	}
	...
	.svws-ui--sidebar--menu-item--collapsed
		.svws-ui--sidebar--menu-item--label {
