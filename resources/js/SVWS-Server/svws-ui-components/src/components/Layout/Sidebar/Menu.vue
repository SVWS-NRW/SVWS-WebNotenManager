			...
			>
				<svws-ui-icon
					><i-ri-arrow-right-s-line
						v-if="collapsed" /><i-ri-arrow-left-s-line v-else
				/></svws-ui-icon>
			</button>
		</div>
...
<style>
	.svws-ui--sidebar--menu {
		@apply svws-ui-flex svws-ui-min-h-full svws-ui-flex-1 svws-ui-flex-col;
		@apply svws-ui-w-56;
	...
	.svws-ui--sidebar--menu--collapse {
		...
		@apply svws-ui-translate-y-1/2 svws-ui-transform;
	...
	.svws-ui--sidebar--menu--body {
		@apply svws-ui-flex svws-ui-flex-1 svws-ui-flex-col;
		@apply svws-ui-py-4;
	}
