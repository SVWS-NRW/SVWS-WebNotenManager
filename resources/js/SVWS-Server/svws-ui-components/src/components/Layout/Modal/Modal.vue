<template>
	<Dialog :open="isOpen" class="svws-ui--modal--wrapper" @close="closeModal">
		<div class="svws-ui--modal--pageWrapper">
			...
			>
				<div class="svws-ui--modal--titlebar">
					...
					/></dialog-title>
					<button
						class="svws-ui--modal--closeButton"
						@click="closeModal"
					>
				...
				<div class="svws-ui--modal-content">
...
<style>
	...
	.svws-ui--modal--closeButton:focus {
		@apply svws-ui-bg-light;
		@apply svws-ui-outline-none svws-ui-ring svws-ui-ring-primary svws-ui-ring-opacity-50;
	}
	...
	.svws-ui--modal--sm {
		@apply svws-ui-w-full svws-ui-max-w-modal-sm;
	}

	.svws-ui--modal--md {
		@apply svws-ui-w-full svws-ui-max-w-modal-md;
	}

	.svws-ui--modal--lg {
		@apply svws-ui-w-full svws-ui-max-w-modal-lg;
	}

	.svws-ui--modal--title {
		@apply svws-ui-flex-grow;
		@apply svws-ui-text-caption svws-ui-uppercase svws-ui-text-black;
	}

	.svws-ui--modal--description {
		@apply svws-ui-text-center svws-ui-font-bold svws-ui-text-black;
	}
