<template>
	<div id="contentSidebar" class="svws-ui-px-8 svws-ui-py-6">
		<h5
			class="svws-ui-headline-2 svws-ui-flex svws-ui-items-center svws-ui-space-x-2 svws-ui-text-black"
		>
			<slot name="header" />
		</h5>
		...
		methods: {
			handleWidth() {
				...
				this.sidebarWidth = Math.floor(
					this.mainWidth * this.sizeMultiplier
				);
