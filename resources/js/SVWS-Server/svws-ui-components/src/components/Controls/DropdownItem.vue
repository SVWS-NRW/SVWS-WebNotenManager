<template>
	<menu-item v-slot="{ active }" :disabled="disabled">
		<button
			...
			@click="onClick"
		>
			<svws-ui-icon class="svws-ui--dropdown--item--icon"
				><slot></slot
			></svws-ui-icon>
			<slot />
		</button>
...
<style>
	.svws-ui--dropdown--item {
		@apply svws-ui-text-left svws-ui-text-button svws-ui-font-bold svws-ui-text-black;
	...
	.svws-ui--dropdown--item:focus {
		@apply svws-ui-outline-none svws-ui-ring-2;
	}
