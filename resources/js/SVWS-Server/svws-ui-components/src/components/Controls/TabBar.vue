<template>
	<div class="svws-ui--tab-bar--wrapper">
		...
		>
			<button
				class="svws-ui--tab-bar--scroll-button"
				@click="scroll('left')"
			>
				<svws-ui-icon><i-ri-arrow-left-line /></svws-ui-icon>
			</button>
		</div>
		<div id="content" class="svws-ui--tab-bar">
			<svws-ui-tab-button
		...
		methods: {
			...
			handleScroll() {
				...
				this.maxScrollLeft =
					this.element.scrollWidth - this.element.clientWidth;
				this.scrolledMax =
					this.element.scrollLeft >= this.maxScrollLeft;
			},
			scroll(direction) {
...
<style>
	...
	.svws-ui--tab-bar--scroll-button-background {
		...
		@apply svws-ui-from-transparent svws-ui-via-light svws-ui-to-light;
	}
	...
	.svws-ui--tab-bar--scroll-button:focus {
		@apply svws-ui-outline-none svws-ui-ring svws-ui-ring-inset svws-ui-ring-primary svws-ui-ring-opacity-75;
	}
</style>
