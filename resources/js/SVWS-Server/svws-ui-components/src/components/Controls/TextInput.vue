<template>
	<label
		...
		:class="{
			...
			'svws-ui--text-input--icon': hasIcon,
	...
	>
		...
		></svws-ui-icon>
		<svws-ui-icon
			class="svws-ui-text-input--calendar-icon"
			v-else-if="type === 'date'"
			><i-ri-calendar-line
		/></svws-ui-icon>
	</label>
...
<style>
	.svws-ui--text-input {
		...
		@apply svws-ui-overflow-hidden svws-ui-whitespace-nowrap;
	}
	...
	.svws-ui--text-input .svws-ui--icon {
		...
		@apply svws-ui-items-center svws-ui-justify-center;
	...
	.svws-ui--text-input--control {
		...
		@apply svws-ui-rounded svws-ui-border svws-ui-border-black svws-ui-border-opacity-20;
	...
	@-moz-document url-prefix() {
		.svws-ui--text-input-focus .svws-ui-text-input--calendar-icon,
		.svws-ui--text-input-filled .svws-ui-text-input--calendar-icon {
