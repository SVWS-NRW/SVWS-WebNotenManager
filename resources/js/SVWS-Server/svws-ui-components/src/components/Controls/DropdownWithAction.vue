<template>
	<Menu as="div" class="svws-ui--dropdown-with-action--wrapper">
		...
		>
			<svws-ui-icon class="svws-ui--dropdown-with-action--icon"
				><i-ri-arrow-up-s-line v-if="open" /><i-ri-arrow-down-s-line
					v-else
			/></svws-ui-icon>
		</menu-button>
		<menu-items
...
<style>
	...
	.svws-ui--dropdown-with-action--button:focus {
		@apply svws-ui-outline-none svws-ui-ring;
	}
	...
	.svws-ui--dropdown--items {
		@apply svws-ui-absolute svws-ui-top-4 svws-ui-z-0;
