...
class="textarea-input" :class="{
		...
		<textarea
class="textarea-input--control" :value="modelValue" :required="required" :disabled="disabled"
			@input="onInput" @focus="onFocus" @blur="onBlur" @click="onClick" @mousedown="onMouseDown"
			@keydown="onKeyDown"></textarea>
		<span
v-if="placeholder" class="textarea-input--placeholder" :class="{
